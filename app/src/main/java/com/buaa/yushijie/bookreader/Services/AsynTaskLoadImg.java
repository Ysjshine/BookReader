...
public class AsynTaskLoadImg extends AsyncTask<String,Integer,Uri> {
    private DownLoadBookInfoService service = new DownLoadBookInfoService();
    private ImageView coverImage;
    private File caches;

    public AsynTaskLoadImg(DownLoadBookInfoService service,ImageView coverImage,File caches) {
        super();
        this.caches = caches;
